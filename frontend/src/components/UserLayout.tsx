          ...
          {navSections.map((section, idx) => (
            <div key={idx} className="space-y-1">
              {section.title && !isCollapsed && (
                <div className="px-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1 mt-3">
                  {section.title}
                </div>
              )}
              {section.title && isCollapsed && (
        ...
        <div className="p-3 border-t border-slate-100 bg-slate-50/50">
          <div
            className={`flex transition-all duration-300 ${
              isCollapsed ? "flex-col items-center space-y-3" : "flex-row items-center p-3 rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-md justify-between"
            }`}
          >
            <div className={`flex items-center transition-all duration-300 ${
              isCollapsed ? "w-12 h-12 justify-center rounded-lg bg-white border border-slate-200 shadow-sm" : "space-x-3 overflow-hidden"
            }`}>
